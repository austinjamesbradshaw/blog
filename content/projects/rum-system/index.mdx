...
- **AWS CloudWatch** - Our team is deep in the AWS ecosystem. It's where our infra lives... our backend team was using CloudWatch for their observability... it was a natural consideration for us. Our access to the ecosystem allowed us to easily put together a proof of concept using CloudWatch Logs and a dashboard.
